...
$objE1 = neW Equipo("Equipo Uno", "Cap.Uno",5,$catMayores);
$objE2 = neW Equipo("Equipo Dos", "Cap.Dos",5,$catMayores);
...
// $torneo->ingresarPartido($objE7, $objE8, "2024-05-05", "Basquet");
$torneo->ingresarPartido($objE5, $objE11, "2024-05-23", "Futbol");
$torneo->ingresarPartido($objE11, $objE11, "2024-05-23", "Futbol");
$torneo->ingresarPartido($objE9, $objE10, "2024-05-23", "Basquet");
